...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 13 13:48:36 2017
...
Gist
 ...
 Watch 254
  Star 3,568
 Fork 880 Microsoft/LightGBM
 Code  Issues 27  Pull requests 2  Wiki Insights 
Branch: master Find file Copy pathLightGBM/examples/python-guide/advanced_example.py
e9275fb  on Apr 2
@JayveeHe JayveeHe Add Python examples on how to load models (#371)
3 contributors @wxchan @guolinke @JayveeHe
RawBlameHistory    
172 lines (140 sloc)  5.2 KB
# coding: utf-8
